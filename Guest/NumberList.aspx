<%@ Page Title="猜獎539-歷史開獎機率" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NumberList.aspx.cs" Inherits="com.oli365.prize.Member.NumberList" %>
...
<div style="margin-top:20px;"  >
    <asp:GridView ID="gv" runat="server" Width="100%" OnRowDataBound="gv_RowDataBound" AutoGenerateColumns="false">
        <Columns>
            ...
            <asp:TemplateField HeaderText="期數分析">
                <ItemTemplate >
